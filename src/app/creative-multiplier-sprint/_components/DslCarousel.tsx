...
const slides: Slide[] = [
  {
    ...
    body: 'The sales argument still works. The visible wrapper is getting tired. Next: separate the idea from the face.',
    variant: 'pressure',
  },
  {
    eyebrow: '02 / Diagnosis',
    title: 'The ad is not dead. The face is tired.',
    body: 'Your offer can still be strong while the same creator, tone, and delivery stop earning attention. Next: why waiting gets expensive.',
    variant: 'face',
  },
  {
    eyebrow: '03 / Delay',
    title: 'By the time the batch lands, CPA may already be moving.',
    body: 'Briefs, shipping, filming, editing, and revisions can take weeks. Your buyer needs fresh tests this week. Next: why guessing is worse.',
    variant: 'delay',
  },
  {
    eyebrow: '04 / Risk',
    title: 'Random new concepts reset the learning.',
    body: 'If one ad already proved it can sell, changing everything turns the next test into a gamble. Next: the controlled path.',
    variant: 'risk',
  },
  {
    eyebrow: '05 / Method',
    title: 'Preserve the winner. Change the avatar layer.',
    body: 'Keep the reason people buy. Change the visible delivery so the same winner gets more shots. Next: what stays locked.',
    variant: 'method',
  },
  {
    eyebrow: '06 / Preserve',
    title: 'Do not rewrite the thing that made people buy.',
    body: 'Hook, offer, proof, objections, pacing, and CTA do not get lost in AI randomness. Next: what actually changes.',
    variant: 'preserve',
  },
  {
    eyebrow: '07 / Change',
    title: 'Same argument. Different avatar profiles.',
    body: 'Test who the message lands through: different ethnicities, body types, ages, and delivery styles without rebuilding the strategy. Next: the mechanism.',
    variant: 'matrix',
  },
  {
    eyebrow: '08 / Mechanism',
    title: 'That is the Winner Avatar Multiplier.',
    body: 'One proven ad becomes a controlled batch of avatar-led versions built for paid-social testing. Next: what you need to send.',
    variant: 'mechanism',
  },
  {
    eyebrow: '09 / Input',
    title: 'You do not need a creative brief. You need one proven ad.',
    body: 'No full brief before booking. If the sprint is a fit, the winner gives us the structure to multiply. Next: what comes back.',
    variant: 'input',
  },
  {
    eyebrow: '10 / Output',
    title: 'You get 10 avatar videos, not a tool login.',
    body: 'Finished vertical files. Same core concept. New avatar-led delivery. Ready for Meta, TikTok, Reels, or Shorts. Next: how fast.',
    variant: 'output',
  },
  {
    eyebrow: '11 / Speed',
    title: 'Fresh tests before the winner burns out.',
    body: 'The sprint is built for speed because winners do not stay fresh forever. Next: how we avoid raw AI slop.',
    variant: 'speed',
  },
  {
    eyebrow: '12 / QA',
    title: 'Not raw AI exports. QA checked creative.',
    body: 'We review clarity, pacing, brand fit, and whether each file is usable as paid-social creative. Next: what happens if it is not usable.',
    variant: 'qa',
  },
  {
    eyebrow: '13 / Guarantee',
    title: 'Usable creative after one revision pass or refund.',
    body: 'No ROAS promises. Just launch-ready creative after one revision pass, or your payment back. Next: see if your ad is a fit.',
    variant: 'guarantee',
  },
  {
    eyebrow: '14 / Apply',
